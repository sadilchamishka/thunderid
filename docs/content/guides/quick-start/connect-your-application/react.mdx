...
<TutorialHeroItem icon={<Package />}>Install the <code>@asgardeo/react</code> package</TutorialHeroItem>
...
<TutorialHeroItem icon={<Server />}>Steps 1–3 complete: ThunderID running, an application registered, and a sign-in flow built. Start at [Get ThunderID](../../getting-started/get-thunderid) if you haven't already.</TutorialHeroItem>
